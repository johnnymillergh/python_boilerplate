...
_alice_public_key_path = (
    get_resources_dir()
    / "pgp-keys/Johnny Miller's PGP Example - Alice_0x3A9AA381_public.asc"
)
alice_public_key: Final[PGPKey] = PGPKey.from_file(_alice_public_key_path.__str__())[0]
_alice_secret_key_path = (
    get_resources_dir()
    / "pgp-keys/Johnny Miller's PGP Example - Alice_0x3A9AA381_SECRET.asc"
)
alice_secret_key: Final[PGPKey] = PGPKey.from_file(_alice_secret_key_path.__str__())[0]

_bob_public_key_path = (
    get_resources_dir()
    / "pgp-keys/Johnny Miller's PGP Example - Bob_0xAF34CAD3_public.asc"
)
bob_public_key: Final[PGPKey] = PGPKey.from_file(_bob_public_key_path.__str__())[0]
_bob_secret_key_path = (
    get_resources_dir()
    / "pgp-keys/Johnny Miller's PGP Example - Bob_0xAF34CAD3_SECRET.asc"
)
